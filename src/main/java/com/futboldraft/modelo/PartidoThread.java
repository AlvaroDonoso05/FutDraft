...
public class PartidoThread extends Thread{
	...
	public void run() {
		...
		bbdd.insertarPartido(partido);
		eventosPartidos.get(nombrePartido).add("Resultado: ");
		eventosPartidos.get(nombrePartido).add(equipoLoc.getNombre() + ": " + golesLoc);
		eventosPartidos.get(nombrePartido).add(equipoVis.getNombre() + ": " + golesVis);
